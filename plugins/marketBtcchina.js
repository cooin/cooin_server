...
exports.register = (server, options, next) => {
  ...
  internal.queryTrade = (coinType, sourceId) => {
    return new Promise((resolve, reject) => {
      ...
      request({
        url: `https://data.btcchina.com/data/historydata?${qs.stringify(query)}`,
        method: "GET",
        json: true
  ...
  internal.queryDepth = (coinType) => {
    return new Promise((resolve, reject) => {
      request({
        url: `https://data.btcchina.com/data/orderbook?market=${coinType}cny`,
        method: "GET",
        json: true
      }, function (err, httpResponse, body) {
        if (err) reject(err);
